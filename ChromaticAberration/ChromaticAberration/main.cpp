...
int main(int argc, char ** argv)
{
	...
	OpenGLEngine::Shader chromaticShader("chromatic.vert", "chromatic.frag");
	...
	//cube_mapPath = "Resources/Textures/SaintPeter/";
	...
	// Model
	glm::vec3 meshPos(0.0, -1.0, 0.0);
	OpenGLEngine::Geometry model_geometry("Resources/Models/clumsy-dragon.obj", meshPos, 2.0);
	//OpenGLEngine::Geometry model_geometry("Resources/Models/sphere.obj", meshPos, 2.0);
	...
	// Model
	std::vector<OpenGLEngine::Texture *> textureVec = { &envMap };
	std::vector<OpenGLEngine::Uniform *> uniformVec = {};
	OpenGLEngine::Material model_material(&textureVec, &uniformVec, &chromaticShader);
