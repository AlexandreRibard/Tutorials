...
int main(int argc, char ** argv)
{
	...
	// GEOMETRY
	/////////////////////////////
	glm::vec3 meshPos = glm::vec3(0.0, -2.0, 0.0);
	...
	// MATERIAL
	/////////////////////////////
	std::vector<OpenGLEngine::Uniform *> uniformVec = { };
	OpenGLEngine::Material normalPlotMaterial(&std::vector<OpenGLEngine::Texture *>(), &uniformVec, &normalShader);
	OpenGLEngine::Material pbrWireframeMaterial(&std::vector<OpenGLEngine::Texture *>(), &uniformVec, &pbrShader);

	/////////////////////////////
	// MESH
	/////////////////////////////
	OpenGLEngine::Mesh clumbsy_dragon(&mesh_geometry, &pbrWireframeMaterial);
	...
	while (window.isOpen())
	{
		...
		clumbsy_dragon.setMaterial(&pbrWireframeMaterial);
		scene.drawMesh(&clumbsy_dragon, &camera, &window);

		//glClear(GL_DEPTH_BUFFER_BIT);

		clumbsy_dragon.setMaterial(&normalPlotMaterial);
		scene.drawMesh(&clumbsy_dragon,&camera, &window);
