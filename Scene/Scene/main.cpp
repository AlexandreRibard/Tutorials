...
int main(int argc, char ** argv)
{
	...
	/////////////////////////////
	OpenGLEngine::Shader stencilShader("stencil.vert", "stencil.frag");
	...
	/////////////////////////////
	// Model
	OpenGLEngine::Material model_material(&std::vector<OpenGLEngine::Texture *>(), &std::vector<OpenGLEngine::Uniform *>(), &textureShader);
